...
#define CPPNL_HOST_DOWN WSAEHOSTDOWN
#define CPPNL_NONBLOCKING_OP_ALREADY_IN_PROGRESS WSAEALREADY
#define CPPNL_BLOCKING_OP_ALREADY_IN_PROGRESS WSAEINPROGRESS
...
#define CPPNL_HOST_DOWN EHOSTDOWN
#define CPPNL_NONBLOCKING_OP_ALREADY_IN_PROGRESS EALREADY
#define CPPNL_BLOCKING_OP_ALREADY_IN_PROGRESS EINPROGRESS
